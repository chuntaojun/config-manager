...
public class TransactionIdSnapshotOperateImpl implements SnapshotOperate {
    ...
    private final ClusterMeta clusterMeta = new ClusterMeta("com.lessspring.org.transactionIdManager");
    ...
    public void onSnapshotSave(SnapshotWriter writer, Closure done) {
        ...
        try {
            ...
            log.error("[TransactionIdSnapshotOperateImpl onSnapshotSave] has some error : {}", e);
        }
    }
    ...
    public boolean onSnapshotLoad(SnapshotReader reader) {
        try {
            ...
            Map<String, TransactionId> snapshot = GsonUtils.toObj(json, new TypeToken<Map<String, TransactionId>>() {
            });
