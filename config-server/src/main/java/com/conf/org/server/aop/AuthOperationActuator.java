 ...
 */
package com.conf.org.server.aop;
...
import com.conf.org.server.exception.AuthForbidException;
...
public class AuthOperationActuator implements PriorityOrdered {
	...
	@Pointcut(value = "@annotation(com.conf.org.server.configuration.security.NeedAuth)")
	private void auth() {
	}
