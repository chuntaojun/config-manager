...
public class HttpClient implements LifeCycle {
    ...
    public <T>void post(ServerNode node, String path, Headers headers, Query query,
                                   RequestBody requestBody, TypeToken<ResponseData<T>> token, Callback callback) {
    }
    ...
    private <T> void execute(Call call, Callback callback, TypeToken<ResponseData<T>> token) throws IOException {
